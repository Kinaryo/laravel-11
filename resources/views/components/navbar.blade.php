            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/" :active="request()->is('/')">Home</x-navbar-link>
                        <x-nav-link href="/posts" :active="request()->is('posts')">blog</x-navbar-link>
                        <x-nav-link href="/about" :active="request()->is('about')">about</x-navbar-link>
                        <x-nav-link href="/contact" :active="request()->is('contact')">contact</x-navbar-link>
